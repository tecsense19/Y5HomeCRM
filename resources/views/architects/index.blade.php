                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex gap-1 justify-content-left">
                                <a href="{{ route('architects.show', $a) }}" class="btn btn-xs btn-outline-primary btn-sm" title="View"><i class="bi bi-eye"></i></a>
                                <a href="{{ route('architects.edit', $a) }}" class="btn btn-xs btn-outline-secondary btn-sm" title="Edit"><i class="bi bi-pencil"></i></a>
