    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <span>Create New Architect</span>
            </div>
            <div class="card-body">
                <form action="{{ route('architects.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="firm_name" id="firm_name" class="form-control @error('firm_name') is-invalid @enderror" value="{{ old('firm_name') }}">
                        @error('firm_name')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-4">
                        ...
                        <button type="submit" class="btn btn-primary">Save Architect</button>
                    </div>
                </form>
            </div>
        </div>
