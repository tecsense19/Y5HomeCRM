    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="{{ route('customers.show', $customer) }}" class="btn btn-outline-secondary btn-sm me-1">
                        Cancel
                    </a>
                ...
                <form action="{{ route('customers.update', $customer) }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="mobile_number" id="mobile_number" class="form-control" value="{{ old('mobile_number', $customer->mobile_number) }}" required>
                        </div>
                    </div>
