        ...
        <form method="POST" action="{{ route('site-visits.update', $siteVisit) }}">
            ...
            <div class="card mb-3">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('site-visits.show', $siteVisit) }}" class="btn btn-outline-secondary btn-sm">Cancel</a>
                </div>
                <div class="card-body">
                    @if ($errors->any())
            ...
            <div class="d-flex gap-2">
                <button class="btn btn-primary px-4">Update Visit</button>
                <a href="{{ route('site-visits.show', $siteVisit) }}" class="btn btn-outline-secondary">Cancel</a>
            </div>
        </form>
    </div>
</div>
